...
size_t findSet(pointer phys_addr)
{
  ...
  static const size_t h2[] = { 14, 17 };
  static const size_t h3[] = { 15, 18 };
...
int main(int argc, char *argv[]) {
    ...
    for (std::iterator<set<addrpair> > it = addr_pool.begin() ; it != addr_pool.end() ; it ++)
    {
